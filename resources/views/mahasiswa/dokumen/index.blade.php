...
<main id="main-content" class="max-w-6xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
    ...
    <nav class="no-print flex items-center gap-2 text-sm text-slate-500 dark:text-slate-400 mb-8">
        ...
        <span class="text-slate-900 dark:text-slate-100 font-medium">My Documents</span>
    </nav>
    ...
    <div class="space-y-12">
        ...
        <section class="bg-white dark:bg-slate-900 rounded-xl shadow-lg border border-slate-200 dark:border-slate-800 overflow-hidden">
            <div class="p-6 border-b border-slate-200 dark:border-slate-700 flex justify-between items-center bg-slate-50 dark:bg-slate-800/50">
                <div>
                    ...
                    <p class="text-sm text-slate-500">Gunakan kartu ini sebagai tanda pengenal saat ujian.</p>
                </div>
                @if($pendaftaran)
        ...
        <section class="bg-white dark:bg-slate-900 rounded-xl shadow-lg border border-slate-200 dark:border-slate-800 overflow-hidden">
            <div class="p-6 border-b border-slate-200 dark:border-slate-700 flex justify-between items-center bg-slate-50 dark:bg-slate-800/50">
                <div>
                    <h2 class="text-xl font-bold">Sertifikat Hasil EPT</h2>
                    <p class="text-sm text-slate-500">Sertifikat resmi hasil ujian English Proficiency Test.</p>
                </div>
            ...
            <div class="p-8 flex justify-center bg-slate-50/30 dark:bg-slate-900/30" id="certificate-area">
                ...
                @else
                    <div class="text-center py-20 w-full">
                        ...
                        <h3 class="text-lg font-medium text-slate-600 dark:text-slate-400">"Unduh sertifikat disini setelah ujian"</h3>
                        <p class="text-sm text-slate-400 dark:text-slate-500 mt-2">Sertifikat akan muncul otomatis setelah Admin mengunggah hasil skor EPT Anda.</p>
                    </div>
                @endif
            </div>
        </section>

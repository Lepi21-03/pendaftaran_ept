...
@section('title', 'Forgot Password | EPT Portal')
    ...
    <div class="w-full max-w-[440px] bg-white dark:bg-slate-900 rounded-xl shadow-xl border border-slate-200 dark:border-slate-800 overflow-hidden">
        <div class="p-8 sm:p-10">
            <div class="mb-8 text-center">
                ...
                <h1 class="text-2xl font-bold text-slate-900 dark:text-slate-100 mb-2">Forgot Password?</h1>
                <p class="text-slate-500 dark:text-slate-400 text-sm">No worries! Masukkan email Anda dan kami akan mengirimkan link untuk mereset password Anda.</p>
            </div>
            ...
            <form action="{{ route('mahasiswa.password.email') }}" class="space-y-6" method="POST">
                ...
                <div class="mt-6 text-center">
                    <a href="{{ route('mahasiswa.login') }}" class="text-sm font-medium text-slate-500 hover:text-primary transition-colors flex items-center justify-center gap-1">
